...
# Install PHP + mods
RUN apk add rsync git curl php${php_version} php${php_version}-json php${php_version}-mbstring php${php_version}-openssl php${php_version}-phar php${php_version}-curl g++ make autoconf zip unzip php-zip bash && \
    # Install Composer \
